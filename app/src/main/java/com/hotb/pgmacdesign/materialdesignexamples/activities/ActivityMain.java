...
import com.hotb.pgmacdesign.materialdesignexamples.anim.AnimationUtils;
import com.hotb.pgmacdesign.materialdesignexamples.extras.SortListener;
import com.hotb.pgmacdesign.materialdesignexamples.fragments.FragmentBoxOffice;
import com.hotb.pgmacdesign.materialdesignexamples.fragments.FragmentDrawer;
...
import com.hotb.pgmacdesign.materialdesignexamples.services.ServiceMoviesBoxOffice;
...
public class ActivityMain extends ActionBarActivity implements MaterialTabListener, View.OnClickListener {
    ...
    public void onDrawerItemClicked(int index) {
        L.m("Pager called at position " + index); ///////////////////////////////////////////////////////////////////////
        //This is where I will set the respective window to open. Setup a switch case and have it open the respective thing
        //position 0 should be main profile
        if(index == 0){
            ...
            logic pattern. If this is NOT using tabs and instead is opening up a new fragment
            altogether, I do not need to subtract the one, I can just repurpose the numbers
             */
            index -= 1;
        }
...
////////Will need to look more into the ViewPager, it will likely be easier to use then manually managing things.//////////////
...
//            L.m("getItem called for " + num);
            switch (num) {
                ...
                case TAB_UPCOMING:
                    ...
                    break;
///////////////////////////////ADD NEW Tabs here if you want to use a tab layout //////////////////////////////////////////
            }
            return fragment;
