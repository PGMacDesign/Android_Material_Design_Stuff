...
import com.hotb.pgmacdesign.materialdesignexamples.activities.ActivityMain;
import com.hotb.pgmacdesign.materialdesignexamples.adapters.AdapterDrawer;
...
public class FragmentDrawer extends Fragment {
 ...
 //////////////////((ActivityMain) getActivity()).onDrawerItemClicked(position -1);///////////////////////////////////////////
                ((ActivityMain) getActivity()).onDrawerItemClicked(position); //TESTING NOT HAVING -1 IN THERE
            }

            @Override
            public void onLongClick(View view, int position) {
                //Add things here for onLongClick. Don't forget to subtract 1!
            }
        }));
    ...
    public void setUp(int fragmentId, DrawerLayout drawerLayout, final Toolbar toolbar) {
        ...
        mDrawerToggle = new ActionBarDrawerToggle(getActivity(), drawerLayout, toolbar, R.string.drawer_open, R.string.drawer_close) {
            ...
            public void onDrawerOpened(View drawerView) {
                ...
                //TESTING SETUP WITH THE CIRCULAR IMAGE VIEW
                CircularImageView circularImageView = (CircularImageView) getActivity().findViewById(R.id.image_profile);
                try{
                    circularImageView.setImageResource(R.drawable.ic_launcher);
                    /*
                    Check here if they have a photo saved, if so, set it.
                    If they do not, set it to the default picture image
                    This will be used to set their information
                     */
                    circularImageView.setOnClickListener(new View.OnClickListener() {
                        @Override
                        public void onClick(View v) {
                            L.m("TESTING CLICKS HERE");
                        }
                    });
                } catch (Exception e){
                    e.printStackTrace();
                }
                //END TESTING SETUP WITH THE CIRCULAR IMAGE VIEW
